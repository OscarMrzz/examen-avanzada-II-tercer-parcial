 ...
 * @author ossca
 */
public class inventarioVista extends javax.swing.JDialog {
     ...
     */
    public inventarioVista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO", "Nombre", "Stock", "Stock Mínimo", "Precio Venta", "Proveedor", "Estado Stock"
            }
        ));
        jScrollPane1.setViewportView(tabla);

        inputBusqueda.setText("Buscar en inventario...");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new inventarioVista(new javax.swing.JFrame(), true).setVisible(true));
    }
