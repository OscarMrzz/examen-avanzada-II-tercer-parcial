 ...
 * @author ossca
 */
public class proveedoresVista extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(proveedoresVista.class.getName());

    /**
     * Creates new form proveedoresVista
     */
    public proveedoresVista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        inputBusqueda.setText("Buscar proveedor...");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new proveedoresVista(new javax.swing.JFrame(), true).setVisible(true));
    }
