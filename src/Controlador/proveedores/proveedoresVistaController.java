...
/**
 * Controlador para la vista de proveedores
 * @author ossca
 */
public class proveedoresVistaController {
    ...
    public proveedoresVistaController(proveedoresVista vista) {
        this.vista = vista;
    ...
    public void cargarTabla() {
        ...
        String sql = "SELECT id_proveedor, nombre, rtn, telefono, contacto, estado FROM proveedores ORDER BY id_proveedor";
    ...
    private void buscar(ActionEvent e) {
        ...
        String sql = "SELECT id_proveedor, nombre, rtn, telefono, contacto, estado FROM proveedores " +
                    "WHERE nombre LIKE ? OR rtn LIKE ? OR telefono LIKE ? OR contacto LIKE ? ORDER BY id_proveedor";
    ...
    private void abrirFormularioAgregar(ActionEvent e) {
        FormularioAgregarProveedor formulario = new FormularioAgregarProveedor(new javax.swing.JFrame(), true);
    ...
    private void abrirFormularioEditar() {
        ...
        // Obtener datos del proveedor seleccionado (se cargarán según los campos del formulario)
        
        FormularioEditarProveedor formulario = new FormularioEditarProveedor(new javax.swing.JFrame(), true);
        
        // Cargar los datos en el formulario (según los campos disponibles)
        // Nota: Necesitarás revisar los campos específicos del formulario de editar proveedor
    ...
    private void eliminar() {
        ...
        int idProveedor = (int) vista.tabla.getValueAt(fila, 0);
        String nombreProveedor = (String) vista.tabla.getValueAt(fila, 1);
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            try (PreparedStatement stmt = conexion.prepareStatement(sql)) {
                ...
                JOptionPane.showMessageDialog(vista, "Error al eliminar el proveedor: " + ex.getMessage(), 
                        "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    /**
     * Abre la ventana de reportes de proveedores
     */
    private void generarReporte(ActionEvent e) {
        reportesProveedores reporte = new reportesProveedores(new javax.swing.JFrame(), true);
