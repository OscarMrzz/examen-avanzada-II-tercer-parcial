...
public class UsuarioType {
    ...
    public UsuarioType(String idUsuario, String nombreUsuario, String userUsuario, 
                      String passUsuario, PrivilegioUsuario privilegioUsuario, 
                      String fotoUsuario, Timestamp fechaCreacion, boolean estadoUsuario) {
